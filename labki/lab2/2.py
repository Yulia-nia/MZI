...
class STB:
    ...
    def encrypt_function(self, data, key):
        tack_keys = extension_key(key)  # до 8
        all_tack_keys = create_K(tack_keys)  # до 56
        data = [1] + data
